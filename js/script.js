...
intranet IN A 192.168.3.3`
    ...
    "sae-telecom-radio": {
      ...
      gallery: [
        ...
        { src: "SAE301 Systeme de communication radio/diag_adapt.png", caption: "Diagramme de rayonnement adapté." },
        { src: "SAE301 Systeme de communication radio/anal_FM.png", caption: "Mesure spectrale d'un signal FM sur analyseur de spectre." },
        { src: "SAE301 Systeme de communication radio/trans_radio.png", caption: "Montage expérimental de la chaîne de transmission radio." },
        ...
        <div style="padding: 2rem 3rem 3rem 3rem; display: flex; flex-direction: column; gap: 2.5rem;">
          ...
          <div style="border-bottom: 1px solid var(--border-color); padding-bottom: 2rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
              ...
              <div style="border: 1px solid var(--border-color); border-radius: var(--radius-sm); overflow: hidden; background: #fff; cursor: zoom-in; display: flex; flex-direction: column;" onclick="window.triggerLightbox('SAE301 Systeme de communication radio/trans_radio.png')">
                <img src="SAE301 Systeme de communication radio/trans_radio.png" alt="Chaîne de transmission radio" style="width:100%; height:120px; object-fit:contain; background-color:#ffffff; display:block;">
                <div style="padding: 10px; font-size: 0.75rem; color: #111; font-weight: 500; line-height: 1.3; border-top: 1px solid var(--border-color);">
          ...
          <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
              ...
              <div style="border: 1px solid var(--border-color); border-radius: var(--radius-sm); overflow: hidden; background: #fff; cursor: zoom-in; display: flex; flex-direction: column;" onclick="window.triggerLightbox('SAE301 Systeme de communication radio/diag_adapt.png')">
                <img src="SAE301 Systeme de communication radio/diag_adapt.png" alt="Rayonnement adapté" style="width:100%; height:120px; object-fit:contain; background-color:#ffffff; display:block; margin: 0 auto;">
                <div style="padding: 10px; font-size: 0.75rem; color: #111; font-weight: 500; line-height: 1.3; border-top: 1px solid var(--border-color);">
                  <strong style="display: block; color: var(--accent); margin-bottom: 2px;">Rayonnement Adapté</strong>
